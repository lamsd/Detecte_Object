...
## edit thiet lap cac cofig file for the system

parser.add_option("-p", "--path", dest="train_path", help="Path to training data.", default="annotate.txt")
parser.add_option("-v", "--pathv", dest="val_path", help="Path to valudation data.", default="testnotate.txt")
...
# Kiem tra file train co duong dan toi file train du lieu khong.
if not options.train_path:   # if filename is not given
	parser.error('Error: path to training data must be specified. Pass --path to command line')
## Pascal_voc la gi 
"""
pascal voc is a dataset with the format of the database 
simple is dataset using the format

defauld of data using is simple.
"""
...
print("Model: {}".format(options.network ))
